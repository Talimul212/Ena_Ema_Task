...
export default function Q_and_ACard({ question, answer }: QAndAType) {
  return (
    <div className="relative group bg-[#1E2B26] rounded-xl p-6 border border-[#2C3A35] hover:border-[#1FFFA5] transition duration-300 shadow-md hover:shadow-lg">
      ...
      <div className="absolute bottom-[60px] left-1/2 transform -translate-x-1/2 translate-y-1/2 w-[600px] h-24 bg-gradient-to-t from-[#1fffa560] to-transparent rounded-full blur-xl opacity-0 group-hover:opacity-50 transition-opacity duration-500 pointer-events-none" />
